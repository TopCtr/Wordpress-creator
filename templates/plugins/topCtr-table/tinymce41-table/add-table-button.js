...
(function(exports, undefined) {
    ...
    define("tinymce/tableplugin/TableGrid", [
        ...
        return function(editor, table) {
            var grid, gridWidth, startPos, endPos, selectedCell, selection = editor.selection,
                dom = selection.dom;
    ...
    define("tinymce/tableplugin/CellSelection", [
        ...
        return function(editor) {
            var dom = editor.dom,
                tableGrid, startCell, startTable, hasCellSelection = true,
                resizing;
    ...
    define("tinymce/tableplugin/Dialogs", [
        ...
        return function(editor) {
            ...
            self.table = function(isProps) {
                var dom = editor.dom,
                    tableElm, colsCtrl, rowsCtrl, classListCtrl, data = {}, generalTableForm;
            ...
            self.cell = function() {
                var dom = editor.dom,
                    cellElm, data, classListCtrl, cells = [];
            ...
            self.row = function() {
                var dom = editor.dom,
                    tableElm, cellElm, rowElm, classListCtrl, data, rows = [],
                    generalRowForm;
    ...
    define("tinymce/tableplugin/Plugin", [
        ...
        function Plugin(editor) {
            var clipboardRows, self = this,
                dialogs = new Dialogs(editor);
